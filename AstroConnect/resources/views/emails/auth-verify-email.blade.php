                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="container">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <h2>Confirm your email to unlock your journey.</h2>
                            <p>Please verify your email address to continue with booking, reviews, and reporting features.</p>
                            <div class="cta">
                                <a href="{{ $actionUrl }}" class="btn">Verify Email</a>
                            </div>
                            <p style="margin-top:18px;color:#94a3b8;">If you did not create this account, no further action is required.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="footer">
