...
<head>
    ...
    <title>Blog Submitted for Review</title>
    <style>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="container">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <h2>A new astrologer blog needs moderation.</h2>
                            <p>An astrologer has submitted content for admin review.</p>
                            <div class="box">
                                <p><strong style="color:#fff7ed;">Author:</strong> {{ $authorName ?? 'Astrologer' }}</p>
                                <p><strong style="color:#fff7ed;">Title:</strong> {{ $title ?? 'N/A' }}</p>
                                <p><strong style="color:#fff7ed;">Category:</strong> {{ $category ?? 'N/A' }}</p>
                                <p><strong style="color:#fff7ed;">Review status:</strong> {{ $status ?? 'Pending' }}</p>
                            </div>
                            <div class="cta">
                                <a href="{{ $actionUrl }}" class="btn">Review Blogs</a>
                            </div>
                            <p style="margin-top:18px;color:#94a3b8;">Approve or reject the blog from the moderation panel.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="footer">
