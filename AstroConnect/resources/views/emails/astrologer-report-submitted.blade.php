...
<head>
    ...
    <title>Astrologer Report Submitted</title>
    <style>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="container">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <h2>A report has been filed for moderation review.</h2>
                            <p>A user submitted a report against an astrologer profile.</p>
                            <div class="box">
                                <p><strong style="color:#fff7ed;">Reporter:</strong> {{ $reporterName ?? 'Verified user' }}</p>
                                <p><strong style="color:#fff7ed;">Reported astrologer:</strong> {{ $astrologerName ?? 'Astrologer' }}</p>
                                <p><strong style="color:#fff7ed;">Reason:</strong> {{ $reason ?? 'N/A' }}</p>
                                <p><strong style="color:#fff7ed;">Status:</strong> {{ $status ?? 'Pending' }}</p>
                            </div>
                            <div class="cta">
                                <a href="{{ $actionUrl }}" class="btn">Open Reports Panel</a>
                            </div>
                            <p style="margin-top:18px;color:#94a3b8;">Please take moderation action after review.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="footer">
