                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="container">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <h2>Your session request is in orbit.</h2>
                            <p>We have successfully received your appointment request on AstroConnect.</p>
                            <div class="box">
                                <p><strong style="color:#fff7ed;">Astrologer:</strong> {{ $astrologerName ?? 'Your astrologer' }}</p>
                                <p><strong style="color:#fff7ed;">Topic:</strong> {{ $topic ?? 'N/A' }}</p>
                                <p><strong style="color:#fff7ed;">Scheduled for:</strong> {{ $scheduledAt ?? 'N/A' }}</p>
                                <p><strong style="color:#fff7ed;">Current status:</strong> {{ $status ?? 'Pending' }}</p>
                            </div>
                            <div class="cta">
                                <a href="{{ $actionUrl }}" class="btn">View My Appointments</a>
                            </div>
                            <p style="margin-top:18px;color:#94a3b8;">We will notify you as soon as the astrologer updates this request.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="footer">
