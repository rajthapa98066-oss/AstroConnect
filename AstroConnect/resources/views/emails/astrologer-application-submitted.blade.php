...
<head>
    ...
    <title>Astrologer Application Submitted</title>
    <style>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="container">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <h2>A new astrologer application is waiting for review.</h2>
                            <p>An AstroConnect user submitted or updated an astrologer application.</p>
                            <div class="box">
                                <p><strong style="color:#fff7ed;">Applicant:</strong> {{ $applicantName ?? 'Unknown user' }}</p>
                                <p><strong style="color:#fff7ed;">Specialization:</strong> {{ $specialization ?? 'N/A' }}</p>
                                <p><strong style="color:#fff7ed;">Experience:</strong> {{ $experienceYears ?? '0' }} years</p>
                                <p><strong style="color:#fff7ed;">Status:</strong> {{ $status ?? 'Pending' }}</p>
                            </div>
                            <div class="cta">
                                <a href="{{ $actionUrl }}" class="btn">Review Applications</a>
                            </div>
                            <p style="margin-top:18px;color:#94a3b8;">Please review the profile details and take moderation action.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="footer">
