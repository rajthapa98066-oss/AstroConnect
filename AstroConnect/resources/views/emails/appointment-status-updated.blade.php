                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="container">
                    ...
                    <tr>
                        <td class="content">
                            ...
                            <h2>Your appointment is now {{ $status ?? 'updated' }}.</h2>
                            <p>The astrologer has updated your appointment request.</p>
                            <div class="box">
                                ...
                                <p><strong style="color:#fff7ed;">New status:</strong> {{ $status ?? 'Updated' }}</p>
                            </div>
                            <div class="cta">
                                <a href="{{ $actionUrl }}" class="btn">Check Appointment</a>
                            </div>
                            <p style="margin-top:18px;color:#94a3b8;">Thank you for choosing AstroConnect.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="footer">
