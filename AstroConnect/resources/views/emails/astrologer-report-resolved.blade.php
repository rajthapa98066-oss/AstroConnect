        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="container">
                    ...
                    <tr>
                        <td class="content">
                            <p class="eyebrow">Report resolved</p>
                            <h2>Your report has been resolved.</h2>
                            <p>Thank you for helping keep AstroConnect safe and trustworthy.</p>
                            <div class="box">
                                <p><strong style="color:#fff7ed;">Reported astrologer:</strong> {{ $astrologerName ?? 'the reported astrologer' }}</p>
                                <p><strong style="color:#fff7ed;">Resolution:</strong> {{ $resolution ?? 'Resolved' }}</p>
                                <p><strong style="color:#fff7ed;">Moderator note:</strong> {{ $adminNote ?? 'No additional note provided.' }}</p>
                            </div>
                            <div class="cta">
                                <a href="{{ $actionUrl }}" class="btn">Browse Astrologers</a>
                            </div>
                            <p style="margin-top:18px;color:#94a3b8;">Our team appreciates your feedback and vigilance.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="footer">
