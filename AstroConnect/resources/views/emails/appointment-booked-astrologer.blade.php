        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="container">
                    ...
                    <tr>
                        <td class="content">
                            <p class="eyebrow">New booking request</p>
                            <h2>A client requested a session.</h2>
                            <p>A new appointment request has been assigned to your profile.</p>
                            <div class="box">
                                <p><strong style="color:#fff7ed;">Client:</strong> {{ $clientName ?? 'A user' }}</p>
                                <p><strong style="color:#fff7ed;">Topic:</strong> {{ $topic ?? 'N/A' }}</p>
                                <p><strong style="color:#fff7ed;">Requested for:</strong> {{ $scheduledAt ?? 'N/A' }}</p>
                            </div>
                            <div class="cta">
                                <a href="{{ $actionUrl }}" class="btn">Manage Appointments</a>
                            </div>
                            <p style="margin-top:18px;color:#94a3b8;">Please update the appointment status after reviewing the request.</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="footer">
